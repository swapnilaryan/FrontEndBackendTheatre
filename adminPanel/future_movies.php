...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
	        	...
	        	<h3 id="forms-example" class="">Upcomming Movies</h3>	<br>
	        	<form class="form-horizontal">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Movie Title</label>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Date</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-dashboard"></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="Date" required=""></div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default">Submit</button>
			  ...
			  <div class="col-xs-6 col-sm-3">Movie Title</div>
