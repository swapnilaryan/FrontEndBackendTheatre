...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
	        	...
	        	<h3 id="forms-example" class="">Social Settings</h3>	<br>
	        	<form class="form-horizontal">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Facebook URL</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-facebook-square"></i>
									</span>
      <input type="email" class="form-control" id="inputEmail3" placeholder="Facebook URL" required=""></div>
    </div>
  </div>
  
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Twitter URL</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-twitter-square"></i>
									</span>
      <input type="email" class="form-control" id="inputEmail3" placeholder="Twitter URL" required=""></div>
    </div>
  </div>
