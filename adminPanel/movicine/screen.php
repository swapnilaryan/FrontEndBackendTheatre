...
<div id="wrapper">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-television"></i>
      ...
      <input type="text" class="form-control" id="inputEmail3" placeholder="Screen Name" required="" ></div>
    </div>
  </div>
...
<div class="form-group">
	...
	<div class="col-sm-8">
		...
		<div class="checkbox-inline"><label><input type="checkbox" disabled=""> Both</label></div>		
	</div>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-dashboard"></i>
      ...
      <input type="text" class="form-control" id="inputEmail3" placeholder="Total Seats" required=""></div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default">Submit</button>
			  ...
			  <div class="col-xs-6 col-sm-3">Screen Name</div>
			  <div class="col-xs-6 col-sm-3">View</div>
			
			  <!-- Add the extra clearfix for only the required viewport -->
			  <div class="clearfix visible-xs-block"></div>
			
			  <div class="col-xs-6 col-sm-3">Total Seat</div>
