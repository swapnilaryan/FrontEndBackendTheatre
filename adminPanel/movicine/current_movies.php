...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
	        	...
	        	<p><h3 id="forms-example" class="">Current Movies</h3>	<br>
	        	<form class="form-horizontal">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Movie Name</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-camera-retro"></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="Movie Name" required=""></div>
    </div>
  </div>
  
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Movie Length</label>

    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-film "></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="Movie Length" required=""></div>
    </div>
  </div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Movie Rating</label>
    <div class="col-sm-10">
      <div class="input-group"><span class="input-group-addon">	<i class="fa fa-pencil"></i>
									</span><input type="text" class="form-control" id="inputEmail3" placeholder="Movie Rating" required=""></div>
    </div>
  </div>

<div class="form-group">
		<label for="selector1" class="col-sm-2 control-label">Screen</label>
...
<div class="form-group">
		<label for="checkbox" class="col-sm-2 control-label">Announce Movies to Social Media</label>
		<div class="col-sm-8">
			<div class="checkbox-inline"><label><input type="checkbox"> Facebook </label></div>
			<div class="checkbox-inline"><label><input type="checkbox" checked="">Twitter </label></div>
		</div>
	</div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default">Submit</button>
			  ...
			  <div class="col-xs-6 col-sm-3">Movie Name</div>
			  <div class="col-xs-6 col-sm-3">Movie Length</div>
			
			  <!-- Add the extra clearfix for only the required viewport -->
			  <div class="clearfix visible-xs-block"></div>
			
			  <div class="col-xs-6 col-sm-3">Screen</div>
