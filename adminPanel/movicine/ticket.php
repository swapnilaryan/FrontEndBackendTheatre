...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
	        		...
	        		<h3 id="forms-example" class=""> Tickets </h3>	<br>
	        	<form class="form-horizontal">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Ticket Name</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-ticket"></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="Ticket Name" required=""></div>
    </div>
  </div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">Ticket Price</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-money"></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="Ticket Price" required=""></div>
    </div>
  </div>
  
<div class="form-group">
	<label for="checkbox" class="col-sm-2 control-label">Ticket Type</label>
	<div class="col-sm-8">
		<div class="checkbox-inline"><label><input type="checkbox"> 2D</label></div>
		<div class="checkbox-inline"><label><input type="checkbox" checked=""> 3D</label></div>
				
	</div>
        </div>

<div class="form-group">
	<label for="radio" class="col-sm-2 control-label">Ticket Groups</label>
	<div class="col-sm-8">
		<div class="radio block"><label><input type="radio">  Kids</label></div>
		<div class="radio block"><label><input type="radio" checked="">Adults</label></div>
		<div class="radio block"><label><input type="radio" disabled=""> Seniors </label></div>
	</div>
</div>

<div class="form-group">
	<label for="radio" class="col-sm-2 control-label">Ticket Slots</label>
	<div class="col-sm-8">
		<div class="radio block"><label><input type="radio"> Matinee</label></div>
		<div class="radio block"><label><input type="radio" checked="">Normal</label></div>
		<div class="radio block"><label><input type="radio" disabled=""> Weekend </label></div>
	</div>
</div>

<div class="form-group">
		<label for="selector1" class="col-sm-2 control-label">Day</label>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default">Submit</button>
			  ...
			  <div class="col-xs-6 col-sm-3">Ticket Name</div>
			  <div class="col-xs-6 col-sm-3">Ticket Group</div>
			
			  <!-- Add the extra clearfix for only the required viewport -->
			  <div class="clearfix visible-xs-block"></div>
			
			  <div class="col-xs-6 col-sm-3">Price</div>
			  <div class="col-xs-6 col-sm-3">Action</div>
			</div>
<div class="row show-grid">
