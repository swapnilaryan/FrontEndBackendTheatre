...
<div id="wrapper">
 	...
 	<div class="blank">
			...
			<div class="blank-page">
	        	...
	        	<h3 id="forms-example" class="">User Account</h3>	<br>
	        	<form class="form-horizontal">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label hor-form">User Name</label>
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-dashboard"></i>
									</span>
      <input type="text" class="form-control" id="inputEmail3" placeholder="User Name"></div>
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10"> <div class="input-group"><span class="input-group-addon">	<i class="fa fa-dashboard"></i>
      ...
      <input type="text" class="form-control" id="inputEmail3" placeholder="Password"></div>
    </div>
  </div>
